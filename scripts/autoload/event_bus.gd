...
# Piece signals
signal piece_select(piece: Piece, coord: Vector2i) # TODO: This will be the signal the clicking over an available piece will send to it to change its state to 'selected' 
